...
class HomeScene extends (React_Component().Component) {
	...
	onCategoryPressed(item,index) {
		(NavigationUtils().default).navPush(this,item.value,null);
	}
	renderList() {
...
HomeScene.__name__ = ["HomeScene"];
HomeScene.prototype.__class__ = HomeScene.prototype.constructor = $hxClasses["HomeScene"] = HomeScene;
