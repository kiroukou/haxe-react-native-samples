...
class Scene1 extends (React_Component().Component) {
	...
	render() {
		...
		return (React()).createElement((react__$ReactType_ReactType_$Impl_$().default).fromComp((react_native_component_View().View)),{ style : Scene1.styles.container},(React()).createElement((react__$ReactType_ReactType_$Impl_$().default).fromComp((react_native_component_Text().Text)),{ style : Scene1.styles.text},"This is Scene1 (one)",msg),(React()).createElement((react__$ReactType_ReactType_$Impl_$().default).fromComp((react_native_component_Button().Button)),{ title : "Back Link", onPress : $bind(this,this.goBack)}),(React()).createElement((react__$ReactType_ReactType_$Impl_$().default).fromComp((react_native_component_FlatList().FlatList)),{ data : this.data, renderItem : $bind(this,this.renderItem), keyExtractor : $bind(this,this.keyExtractor)}));
	}
