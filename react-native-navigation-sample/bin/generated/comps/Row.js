...
Row.__name__ = ["comps","Row"];
Row.prototype.__class__ = Row.prototype.constructor = $hxClasses["comps.Row"] = Row;
...
var styles = (react_native_api_StyleSheet().StyleSheet).create({ row : { height : 30, flexDirection : "row", alignItems : "center", justifyContent : "center", borderBottomWidth : 1, borderBottomColor : "white"}, text : { fontSize : 20, color : "black"}});
var displayName = "Row";
