...
function comps_CustomButton() {return require("./../comps/CustomButton");}
...
class DrawerMenu extends (React_Component().Component) {
	...
	render() {
		...
		return (React()).createElement((react__$ReactType_ReactType_$Impl_$().default).fromComp((react_native_component_View().View)),{ style : styles.view},(React()).createElement((react__$ReactType_ReactType_$Impl_$().default).fromComp((react_native_component_Text().Text)),{ },this.props.text),(React()).createElement((react__$ReactType_ReactType_$Impl_$().default).fromFunctionWithProps((comps_CustomButton().default).render),{ text : "Home"}),(React()).createElement((react__$ReactType_ReactType_$Impl_$().default).fromFunctionWithProps((comps_CustomButton().default).render),{ text : "Blablabla"}),(React()).createElement((react__$ReactType_ReactType_$Impl_$().default).fromFunctionWithProps((comps_CustomButton().default).render),{ text : "Favoris"}),(React()).createElement((react__$ReactType_ReactType_$Impl_$().default).fromFunctionWithProps((comps_CustomButton().default).render),{ text : "Mon Compte"}),(React()).createElement((react__$ReactType_ReactType_$Impl_$().default).fromFunctionWithProps((comps_CustomButton().default).render),{ text : "Réglages"}));
	}
...
DrawerMenu.__name__ = ["comps","DrawerMenu"];
DrawerMenu.prototype.__class__ = DrawerMenu.prototype.constructor = $hxClasses["comps.DrawerMenu"] = DrawerMenu;
