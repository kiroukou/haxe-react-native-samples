...
class Scene3 extends (React_Component().Component) {
	...
	closeModale() {
		(NavigationUtils().default).navDismissModal(this);
	}
	goBack() {
...
Scene3.__name__ = ["scene","Scene3"];
Scene3.prototype.__class__ = Scene3.prototype.constructor = $hxClasses["scene.Scene3"] = Scene3;
