...
function NavigationUtils() {return require("./../NavigationUtils");}
...
function scene_Row() {return require("./../scene/Row");}
...
class Scene1 extends (React_Component().Component) {
	...
	onPressed(o,validated) {
		...
		(NavigationUtils().default).navModalAsOverlay(this,"Popup",{ message : "This Overlay screen to display my value " + o.key},{ topBar : { title : { color : "red", text : "Modale en overlay"}}});
	}
	renderItem(o) {
		...
		return (React()).createElement((react__$ReactType_ReactType_$Impl_$().default).fromComp((scene_Row().default)),rowProps1);
	}
	keyExtractor(o,index) {
		return o.id + "";
	}
	goBack() {
		(NavigationUtils().default).navPop(this);
	}
	render() {
		...
		return (React()).createElement((react__$ReactType_ReactType_$Impl_$().default).fromComp((react_native_component_View().View)),{ style : Scene1.styles.container},(React()).createElement((react__$ReactType_ReactType_$Impl_$().default).fromComp((react_native_component_Text().Text)),{ style : Scene1.styles.text},"This is Scene1",msg),(React()).createElement((react__$ReactType_ReactType_$Impl_$().default).fromComp((react_native_component_Button().Button)),{ title : "Back", onPress : $bind(this,this.goBack)}),(React()).createElement((react__$ReactType_ReactType_$Impl_$().default).fromComp((react_native_component_FlatList().FlatList)),{ data : this.data, renderItem : $bind(this,this.renderItem), keyExtractor : $bind(this,this.keyExtractor)}));
	}
...
Scene1.__name__ = ["scene","Scene1"];
Scene1.prototype.__class__ = Scene1.prototype.constructor = $hxClasses["scene.Scene1"] = Scene1;
