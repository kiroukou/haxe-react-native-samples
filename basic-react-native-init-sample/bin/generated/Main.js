...
var styles = (react_native_api_StyleSheet().StyleSheet).create({ container : { flex : 1, backgroundColor : "#2288AA", flexDirection : "column", justifyContent : "center", alignItems : "stretch"}});
